...
var scm_merge_cli_exports = {};
__export(scm_merge_cli_exports, {
  runScmMergeCli: () => runScmMergeCli
});
module.exports = __toCommonJS(scm_merge_cli_exports);
...
//# sourceMappingURL=scm-merge.cli.cjs.map