...
var scm_abandon_feature_cli_exports = {};
__export(scm_abandon_feature_cli_exports, {
  runScmAbandonFeatureCli: () => runScmAbandonFeatureCli
});
module.exports = __toCommonJS(scm_abandon_feature_cli_exports);
