...
function listAlembicMigrations(projectDir) {
  ...
  const dir = candidates.find((p) => fs7.existsSync(p));
  if (!dir) return [];
...
// scripts/lakebase/schema-migrate.cli.ts
...
var BIN_NAME = "lakebase-schema-migrate";
async function main() {
...
//# sourceMappingURL=schema-migrate.cli.js.map