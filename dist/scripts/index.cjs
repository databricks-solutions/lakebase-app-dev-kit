...
async function commitAllIfChanged(args) {
  ...
  for (const inc of args.include ?? []) {
    if ((0, import_fs6.existsSync)((0, import_path7.join)(args.cwd, inc))) {
...
function isCliEntry(importMetaUrl2) {
  ...
  let moduleResolved;
  try {
    invokedResolved = (0, import_node_fs3.realpathSync)(invokedRaw);
  } catch {
    return false;
  }
  try {
    moduleResolved = (0, import_node_fs3.realpathSync)((0, import_node_url6.fileURLToPath)(importMetaUrl2));
  } catch {
    return false;
  }
