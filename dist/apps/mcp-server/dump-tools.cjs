...
function gitCheckoutNewBranch(cwd, branch, startPoint) {
  ...
  (0, import_node_child_process13.execFileSync)("git", argv, {
    cwd,
    stdio: ["ignore", "pipe", "pipe"],
...
function gitFetchBranch(cwd, remote, branch) {
  try {
    (0, import_node_child_process13.execFileSync)("git", ["fetch", remote, branch], {
      cwd,
      stdio: ["ignore", "pipe", "pipe"],
...
function gitRefExists(cwd, ref) {
  try {
    (0, import_node_child_process13.execFileSync)("git", ["rev-parse", "--verify", "--quiet", ref], {
      cwd,
      stdio: ["ignore", "pipe", "pipe"],
      timeout: KIT_TIMEOUTS.gitDefault
    });
