#!/usr/bin/env node
// lakebase-tdd-response-formatter: the AGENT-SIDE precheck a role runs on its
...
//
//   lakebase-tdd-response-formatter --role test-strategist --feature F1 --story S2 [--tdd-dir D]
//
